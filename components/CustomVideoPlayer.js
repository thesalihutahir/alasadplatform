        ...
        >
          ...
          <div className="flex items-center justify-between mt-1">
            <div className="flex items-center gap-4">
              <button 
                onClick={togglePlay} 
                className="text-white hover:text-yellow-500 transition-colors p-2 -ml-2 rounded-full hover:bg-white/10"
              >
              ...
              <div className="flex items-center gap-2 group/vol">
                ...
                <div className="hidden md:block w-20">
                  <input 
                    ...
                    className="h-1 w-20 bg-white/30 rounded-lg appearance-none cursor-pointer accent-yellow-500"
                  />
                </div>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={toggleFullscreen} className="text-white hover:text-yellow-500 p-2 rounded-full hover:bg-white/10">
